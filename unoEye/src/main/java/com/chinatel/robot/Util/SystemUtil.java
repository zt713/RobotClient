...
public class SystemUtil {
	...
	public static void sendEmail(Context paramContext,
			String[] paramArrayOfString, String paramString1,
		...
		if (paramString3 != null) {
			localIntent.putExtra("android.intent.extra.STREAM",
					Uri.fromFile(new File(paramString3)));
			localIntent.setType("image/png");
		}
		paramContext
				.startActivity(Intent.createChooser(localIntent, "请选择发送软件"));
	}

	public static void sendSMS(Context paramContext, String paramString1,
			String paramString2) {
		...
		for (int i = 0;; i++) {
			if (i >= localArrayList.size())
				return;
			localSmsManager.sendTextMessage(paramString1, null,
					(String) localArrayList.get(i), null, null);
		}
	}
	...
	public static Bitmap takeScreenShot(Activity paramActivity) {
		...
		Bitmap localBitmap2 = Bitmap
				.createBitmap(localBitmap1, 0, i, paramActivity
 ...
 * Qualified Name: com.chinatel.robot.Util.SystemUtil JD-Core Version: 0.6.2
 */